    ...
    <div id="app" class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-dark bg-info app-shadow">
            ...
            <a href="{{ url('/') }}" class="brand-link bg-info mx-auto py-0 d-inline-block d-sm-none">
                <img src="{{ asset('images/pelita.png') }}" alt="APP Logo"
                    class="brand-image p-1 mt-0 ml-0 bg-white img-circle" style="opacity: .8">
        ...
        <aside class="main-sidebar sidebar-light-info elevation-4" style="overflow-x: hidden;">
            <a href="{{ url('/') }}" class="brand-link bg-info">
                <img src="{{ asset('images/pelita.png') }}" alt="APP Logo"
                    class="brand-image p-1 bg-white img-circle" style="opacity: .8">
        ...
        <aside class="control-sidebar control-sidebar-light">
            <div class="p-3">
                <img src="{{ asset('images/user.png') }}" class="img-fluid mx-auto d-block rounded-circle"
                    style="width: 75px">
