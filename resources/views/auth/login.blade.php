...
<div class="login-box">
    <div class="login-logo mb-3">
        <img src="{{ asset('images/pelita.png') }}" alt="Logo" class="img-fluid mx-auto d-block" style="width: 75px">
    </div>
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <br>
            <p>Belu Punya Akun ? <a href="register">Buat Akun</a></p>
            <center>
                <p>Developed By <a href='https://www.instagram.com/lutfi_m7/' title='@lutfi_m7' target='_blank'>@lutfi_m7</a></p>
            </center>
