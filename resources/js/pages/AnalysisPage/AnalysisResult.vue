        ...
        <div class="container">
            <div class="card card-info">
                <div class="card-header d-flex text-center text-sm-left">
                    ...
                    >
                        <i
                            class="fas"
                            :class="
                                view == 'table' ? 'fa-chart-bar' : 'fa-table'
                            "
                        ></i>
                    </a>
                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th nowrap class="text-center table-secondary">
                                    Bobot
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr
                                ...
                                :key="item.id"
                                :class="{
                                    'table-info': item.total == topPoint,
                                }"
                            >
                                <td nowrap>
                ...
                <div class="card-footer text-center py-4">
                    <b>Kesimpulan</b> : Jadi, wisma yang disarankan oleh system
                    adalah
                    <b v-for="item in result" :key="item.id"
                        ><u>"{{ item.name }}"</u>
                        </b
                    >
                </div>
...
export default {
    ...
    methods: {
        init() {
            axios.get("/analysis/result").then(({ data }) => {
